...
![Login Page](\job-application-system\src\assets\img\screenshots\login-filled.png?raw=true "Preview")
### Features : 
...
![Candidate Page](\job-application-system\src\assets\img\screenshots\candidate-jobs.png?raw=true "Preview")

![Employer Page](\job-application-system\src\assets\img\screenshots\jobname1-candidates-initial.png?raw=true "Preview")
